...
fn main() {
  ...
  if target_arch == "x86_64" {
    ...
    if cfg!(feature = "fft_fma") {
      cc::Build::new()
        .cpp(true)
        .file("src/fft/spqlios/fft_processor_spqlios.cpp")
        .file("src/fft/spqlios/spqlios-fft-impl.cpp")
        .file("src/fft/spqlios/spqlios-wrapper.cpp")
        .file("src/fft/spqlios/spqlios-fft-fma.s")
        .file("src/fft/spqlios/spqlios-ifft-fma.s")
        .flag("-std=c++17")
        .flag("-lm")
        .flag("-Ofast")
        .flag("-march=native")
